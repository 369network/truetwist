...
function getJwtRefreshSecret(): string {
  if (!_jwtRefreshSecret) _jwtRefreshSecret = getRequiredEnv('JWT_REFRESH_SECRET');
...
export function generateAccessToken(userId: string, email: string, plan: PlanTier): string {
  return jwt.sign(
